...
contract addLiquidity is Script {
    function run() external {
        ...
        address wrapperFactory = 0x4c01813996b9CB0cbB6942ee1799F80c280D1D2b;
        address router = 0x56aE9D4B2CaB2F9338b3e71f0cA714cB58FC8CCF;
        address factory = 0x1CD0D070b52b41e19E857160022Fa9915581CFa8;
        ...
        IERC20(wrappedToken1).approve(router, 10e18);

        JalaRouter02(payable(router)).addLiquidity(
            wrappedToken0,
            wrappedToken1,
            10e18,
            10e18,
...
// forge script scripts/addliquidity.s.sol:addLiquidity --rpc-url $SPICY_TESTNET --broadcast --legacy
